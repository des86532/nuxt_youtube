<template lang="pug">
  .z-10.sidebar.overflow-hidden.transition-width.duration-150(:class="isSidebarOpen ? 'w-full' : 'w-0'")
    ...
    template(v-else)
      .h-full.bg-gray-700.relative.pb-14.z-10.w-48
        ...
        .w-full.h-14.border-t.text-center.text-white.absolute.bottom-0.flex.justify-center.items-center.cursor-pointer(@click="logout")
          span 登出
      .h-full.flex-1.bg-gray-400.bg-opacity-70.absolute.top-0.w-screen(@click="closeSidebar")
</template>
